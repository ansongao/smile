...
public class UploadServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String savePath = request.getServletContext().getRealPath("WEB-INF/resource/upload");
        ...
        // 上传时生成临时文件保存目录
        String tmpPath = request.getServletContext().getRealPath("WEB-INF/resource/tem");
